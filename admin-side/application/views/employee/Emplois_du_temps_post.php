    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <form class="card-body" action="<?= base_url("index.php/CT_CRUD_Employer/insert_post") ?>"
                        method="post">
                        <h3><?php if (isset($semaine)) {
                                echo $emplois_du_temps[0]['nomposte'] . " <input type='hidden' name='idposte' value=" . $emplois_du_temps[0]['idposte'] . " >";
                            }  ?>
                        </h3>
