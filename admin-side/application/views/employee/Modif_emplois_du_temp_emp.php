    ...
    <div class="content-wrapper main">
        ...
        <div class="row sousmain">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <form class="card-body" action="<?= base_url("index.php/CT_CRUD_Employer/insert_modification_emplois_emp") ?>" method="post" style="background-color:#F1F4F5 ;">
                        ...
                        <div class="col-6" style="float:rigth;">
                            <button type="submit" class="btn btn-primary" style="background-color: #101B3B;">Submit</button>
                        <div>
